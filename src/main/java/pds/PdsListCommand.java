...
public class PdsListCommand implements PdsInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totRecCnt = dao.totRecCnt(part); //전체건수(글 갯수)
		...
		ArrayList<PdsVO> vos = dao.getPdsList(startIndexNo, pageSize, part); //시작하는거부터 한페이지분량만큼 (자료가져옴)
		...
		request.setAttribute("part", part); //계속 붙들고 다녀야함
	}
