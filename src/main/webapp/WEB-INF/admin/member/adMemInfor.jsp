...
<div class="container">
	...
	<table class ="table">
		...
		<tr><td>등급: ${strLevel}</td></tr>  <!-- 등급은 그냥 level로하면 숫자로나옴 -->
		...
		<tr><td><button type="button" class="btn btn-secondary" onclick="location.href='${ctp}/adMemList.ad?pag=${pag}';">돌아가기</button></td></tr><!-- pag번호같이넘겨주기 -->
	</table>
</div>
<p><br/></p>
</body>
