...
<div class="container">
  ...
  <hr/>
  <div>
      품명 : <input type="text" name="product" id="product" value="<%=vo.getProduct()%>" readonly class="form-control mb-3"/> <!-- 값 바꿀필요없어서 readonly -->
      </div>
      <div>
      단가 : <input type="text" name="price" id="price" value="<%=vo.getPrice()%>" readonly class="form-control mb-3"/> <!-- vo.getPrice() :vo찍어보려고 씀 -->
      </div>
      <div>
