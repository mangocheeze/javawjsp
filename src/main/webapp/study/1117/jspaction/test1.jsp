...
<!-- 	<form name="myform" method="post" action="testF1Ok.jsp"> --> <%--jsp에서 jsp로 보낼거니까(자기폴더안에서 보내니까) --%>
<!-- 	<form name="myform" method="post" action="testF2Ok.jsp"> --> <%--프론트에서 사용하는방법 --%>
	<form name="myform" method="post" action="testF3Ok.jsp"> <%--프론트에서 사용하는방법 --%>
		<p>
